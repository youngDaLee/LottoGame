const ranks = new function(){
    this.totalRanking = [
        ...
        {Rank:'2', Name:'박정연', Money:'90,000,000'},
        {Rank:'3', Name:'박정연', Money:'80,000,000'},
        {Rank:'4', Name:'박정연', Money:'70,000,000'},
        {Rank:'5', Name:'박정연', Money:'60,000,000'}
    ]
    ...
    this.createTable = ()=>{
        ...
        for (let i=0; i<this.totalRanking.length; i++) {
            for (let key in this.totalRanking[i]) {
                ...
                // is it means it can be used to add data?
        ...
        //id값 할당. ranktable이라는 이름의 id값을 할당할거야.
        ...
        for(let key of this.col){
            ...
            // props의 내용, 즉 rank, name 등이 테이블 헤더의 값으로 지정된다.
            let th = document.createElement('th');
            th.innerHTML = key; // <th>{key}</th>
